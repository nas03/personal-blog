module.exports.message = Object.freeze({
  ...
  can_not_convert_time: 'convert_time_zone_error',
  ...
  environment_invalid: 'trans.environment_invalid',
})
...
module.exports.dateFormat = Object.freeze({
  ...
  DATE_TIME_7: 'YYYYMMDD_HHmmssSSS',
})
...
module.exports.envCommon = Object.freeze({
  ...
  NODE_ENV_TOKEN: 'NODE_ENV_TOKEN',
  URL_IB_API: 'URL_IB_API',
  NODE_ENV_TOKEN_DEV: 'NODE_ENV_TOKEN_DEV',
  NODE_ENV_TOKEN_STG: 'NODE_ENV_TOKEN_STG',
  NODE_ENV_TOKEN_PROD: 'NODE_ENV_TOKEN_PROD',
  MASKING_DATA_IB_FLAG: 'MASKING_DATA_IB_FLAG',
  WHITE_LIST_IP_IB: 'WHITE_LIST_IP_IB',
})
...
const emailDetailContentIds = {
  EMAIL_ACTIVE_ACCOUNT: 5003,
  EMAIL_CLOSE_ACCOUNT: 5004,
  EMAIL_CREATE_USER_FX: 5005,
  URL_FOR_PASSWORD_RESET: 5007,
  EMAIL_FRAUD_ALERT_FX: 5018,
  EMAIL_URL_FOR_SUBMITTING_CERTIFICATES_FXON: 5022,
  EMAIL_ACCEPT_EKYC: 5023,
  EMAIL_DOCUMENT_DEFICIENCY: 5024,
  EMAIL_CREATE_DEMO_TRADING_ACCOUNT: 5027,
  EMAIL_ADD_DEMO_TRADING_ACCOUNT: 5028,
  ...
  EMAIL_VERIFY_REGISTRATION_MF: 1004,
  EMAIL_FORGOT_PASSWORD_MF: 1006,
  EMAIL_FRAUD_ALERT_MF: 1014,
  EMAIL_ACCEPT_EKYC_MF: 1017,
  EMAIL_DOCUMENT_DEFICIENCY_MF: 1018,
  EMAIL_APPROVED_ACCOUNT_ICPAY: 3003,
  EMAIL_CLOSE_USER_ICPAY: 3004,
  EMAIL_CREATE_USER_ICPAY: 3005,
  EMAIL_FORGOT_PASSWORD_ICPAY: 3007,
  EMAIL_URL_FOR_SUBMITTING_CERTIFICATES_ICPAY: 3022,
  EMAIL_ACCEPT_EKYC_ICPAY: 3023,
  EMAIL_DOCUMENT_DEFICIENCY_ICPAY: 3024,
  EMAIL_ACCEPT_EKYC_XEM: 6025,
  EMAIL_FRAUD_ALERT_ICPAY: 3018,
  EMAIL_REGISTER_COMPLETE_XEM: 6001,
  URL_FOR_EMAIL_VERIFICATION_AT_REGISTRATION: 6009,
}
module.exports.emailDetailContentId = emailDetailContentIds
...
module.exports.siteGroupConstant = Object.freeze({
  FX_PLUS: {
    ...
    SITE_IDS: [2],
    BROKER_IDS: null,
    BROKER_ALLOW_DISPLAY: [1, 2, 3, 4, 5, 14],
    BROKER_DISPLAY_USER_STATISTICS: [1, 14],
  },
  FXS: {
    KEY: 'fxs',
    SITE_IDS: [6, 7, 8],
    BROKER_IDS: [1, 2, 4],
    BROKER_ALLOW_DISPLAY: [1, 2, 4, 14],
    BROKER_DISPLAY_USER_STATISTICS: [1, 14],
  },
  MY_FOREX: {
    KEY: 'my_forex',
...
// -- IB Activity phase 1.04 BEGIN --
module.exports.registrationRebateStatus = Object.freeze({
  NO_UPDATE: 0,
  UPDATED: 1,
})

module.exports.ENVEaServer = Object.freeze({
  DEV: 'DEV',
  PROD: 'PROD',
})

module.exports.metaTradePlatform = Object.freeze({
  MT4: '4',
  MT5: '5',
})

module.exports.standardTimezone = Object.freeze({
  NON: 0,
  US: 1,
  EU: 2,
})
...
module.exports.brokerSummerTimezone = Object.freeze({
  TFX: 3,
  BIG: 3,
  MIL: 1,
  THT: 3,
...
module.exports.brokerWinterTimezone = Object.freeze({
  TFX: 2,
  BIG: 2,
  MIL: 0,
  THT: 2,
...
module.exports.brokerStandardTimezone = Object.freeze({
  TFX: 1,
  BIG: 1,
  MIL: 2,
  THT: 1,
...
module.exports.brokerAbbrev = Object.freeze({
  EXNESS: 'EXN',
  MILTON_MARKET: 'MIL',
  THREE_TRADER: 'THT',
  HFM: 'HOT',
...
module.exports.siteNameCommon = Object.freeze({
  MY_FOREX: ['broker@p2t.sg', '30702179', 'P2Tech', '6211', '8113276', '313723335', '313723336', '313723338', '313723339'],
  FX_PLUS: ['broker@obih.sg', '6000029', '34203335', '34203336', '34203337', '34203338', '34203339', 'broker@obi.sg', 'partner@obi.sg'],
  FXS_TFX: ['8306895'],
})

module.exports.siteNameValue = Object.freeze({
  MY_FOREX: 'Myforex',
  FX_PLUS: 'FXPLUS',
  FXS_TFX: 'FXS-TFX',
})
...
// -- IB Activity phase 1.04 BEGIN --
module.exports.batchSize = Object.freeze({
  SIZE_1: 1000,
})
// -- IB Activity phase 1.04 END --
...
// -- IB Activity share API START --
module.exports.maskingDataFlag = Object.freeze({
  ON: 'ON',
  OFF: 'OFF',
})

module.exports.maskingDataType = Object.freeze({
  NUMBER: 'NUMBER',
  STRING: 'STRING',
})

module.exports.maskingRebateStatistics = Object.freeze([
  {
    key: 'trading_volume',
    type: 'NUMBER',
  },
...
module.exports.maskingRebateHistory = Object.freeze([
  {
    key: 'ticket',
    type: 'NUMBER',
  },
...
module.exports.maskingInduceTraders = Object.freeze([
  {
    key: 'client_id',
    type: 'NUMBER',
  },
...
module.exports.maskingInduceTradersStatistics = Object.freeze([
  {
    key: 'new_account_number',
    type: 'NUMBER',
  },
  {
    key: 'new_account_number_fxs',
    type: 'NUMBER',
  },
  {
    key: 'active_account_number',
    type: 'NUMBER',
  },
  {
    key: 'active_account_number_fxs',
    type: 'NUMBER',
  },
  {
  ...
  {
    key: 'rate_user_active',
    type: 'NUMBER',
  },
  {
    key: 'rate_user_active_fxs',
    type: 'NUMBER',
  },
],
)
// -- IB Activity share API END --

// -- Phase Replace key BEGIN--
module.exports.keyReplaceMail = Object.freeze({
  mailType: [
    {
      name: 'EMAIL_VERIFY_REGISTRATION',
      emailContentDetailId: emailDetailContentIds.EMAIL_VERIFY_REGISTRATION_MF,
      key: 'activationKey',
      attributeSearch: 'href',
    },
    {
      name: 'EMAIL_FORGOT_PASSWORD',
      emailContentDetailId: emailDetailContentIds.EMAIL_FORGOT_PASSWORD_MF,
      key: 'resetKey',
      attributeSearch: 'href',
    },
    {
      name: 'EMAIL_FRAUD_ALERT',
      emailContentDetailId: emailDetailContentIds.EMAIL_FRAUD_ALERT_MF,
      key: 'faKey',
      attributeSearch: 'href',
    },
    {
      name: 'EMAIL_CREATE_USER',
      emailContentDetailId: emailDetailContentIds.EMAIL_CREATE_USER_FX,
      key: 'activationKey',
      attributeSearch: 'href',
    },
    {
      name: 'EMAIL_URL_PASSWORD_RESET',
      emailContentDetailId: emailDetailContentIds.URL_FOR_PASSWORD_RESET,
      key: 'resetKey',
      attributeSearch: 'href',
    },
    {
      name: 'EMAIL_FRAUD_ALERT',
      emailContentDetailId: emailDetailContentIds.EMAIL_FRAUD_ALERT_FX,
      key: 'faKey',
      attributeSearch: 'href',
    },
    {
      name: 'EMAIL_CREATE_USER',
      emailContentDetailId: emailDetailContentIds.EMAIL_CREATE_USER_ICPAY,
      key: 'activationKey',
      attributeSearch: 'href',
    },
    {
      name: 'EMAIL_URL_PASSWORD_RESET',
      emailContentDetailId: emailDetailContentIds.EMAIL_FORGOT_PASSWORD_ICPAY,
      key: 'resetKey',
      attributeSearch: 'href',
    },
    {
      name: 'EMAIL_FRAUD_ALERT',
      emailContentDetailId: emailDetailContentIds.EMAIL_FRAUD_ALERT_ICPAY,
      key: 'faKey',
      attributeSearch: 'href',
    },
    {
      name: 'EMAIL_ADD_DEMO_TRADING_ACCOUNT',
      emailContentDetailId: emailDetailContentIds.EMAIL_ADD_DEMO_TRADING_ACCOUNT,
      key: 'isSendPassword',
      HTMLTag: 'td',
      attributeSearch: 'href',
    },
    {
      name: 'EMAIL_CREATE_DEMO_TRADING_ACCOUNT',
      emailContentDetailId: emailDetailContentIds.EMAIL_CREATE_DEMO_TRADING_ACCOUNT,
      key: 'isSendPassword',
      attributeSearch: 'isSendPassword',
    },
    {
      name: 'CHANGE_MT_STATUS_APPROVED',
      emailContentDetailId: emailDetailContentIds.CHANGE_MT_STATUS_APPROVED,
      key: 'isSendPassword',
      HTMLTag: 'td',
      attributeSearch: 'isSendPassword',
    },
    {
      name: 'CHANGE_MT_STATUS_APPROVED_ADDITIONAL',
      emailContentDetailId: emailDetailContentIds.CHANGE_MT_STATUS_APPROVED_ADDITIONAL,
      key: 'isSendPassword',
      HTMLTag: 'td',
      attributeSearch: 'isSendPassword',
    },
    {
      name: 'URL_FOR_EMAIL_VERIFICATION_AT_REGISTRATION',
      emailContentDetailId: emailDetailContentIds.URL_FOR_EMAIL_VERIFICATION_AT_REGISTRATION,
      key: 'registration/verify',
      attributeSearch: 'href',
    },
    {
      name: 'EMAIL_URL_FOR_SUBMITTING_CERTIFICATES_ICPAY',
      emailContentDetailId: emailDetailContentIds.EMAIL_URL_FOR_SUBMITTING_CERTIFICATES_ICPAY,
      key: 'company/related-person',
      attributeSearch: 'href',
    },
    {
      name: 'EMAIL_URL_FOR_SUBMITTING_CERTIFICATES_FXON',
      emailContentDetailId: emailDetailContentIds.EMAIL_URL_FOR_SUBMITTING_CERTIFICATES_FXON,
      key: 'company/related-person',
      attributeSearch: 'href',
    },
    {
      name: 'EMAIL_REGISTER_COMPLETE_XEM',
      emailContentDetailId: emailDetailContentIds.EMAIL_REGISTER_COMPLETE_XEM,
      key: 'files/qr_code/fxsignup_xem/',
      HTMLTag: 'img',
      attributeSearch: 'src',
    },
  ],
  textReplace: '******************************',
  urlReplace: '#',
  urlPermission: process.env.URL_FE + '/error-permission/',
  textReplacePassword: '*********',
  isSendPassword: 'isSendPassword',
  isKeyOfXEMSite: 'registration/verify',
  urlReplace_2: '#none',
  keysSearch: ['resetKey', 'activationKey', 'faKey'],
  urlReplace: '<a href="" style="pointer-events: none; text-decoration: none; color: black" >',
  imgReplace: 'https://xem.fxsignup.com/common/images/mail/qr.png',
})
// -- Phase Replace key END--
