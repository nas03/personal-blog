...
const closeAccount = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const closeAccount = yield repositories_1.users_basic_data_repository.deleteUserData(user_id);
        if (!closeAccount)
            return (0, utilities_1.createResponse)(res, false, null, consts_1.code.ERROR, consts_1.message.update_failed);
